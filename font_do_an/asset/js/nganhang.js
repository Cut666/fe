...
html =`<div style="text-align: center; font-size: 15px"id="dateuncadd">
    <i><label for="">Ngày chi:</label> 
      <input type="date"  name="dateuncadd" value="${data}"/></i>
  </div>
`
document.getElementById("dateuncadd").innerHTML = html; 
}
function getDate1(data){
html =`<div style="text-align: center; font-size: 15px"id="datebcadd">
    <i><label for="">Ngày chi:</label> 
      <input type="date"  name="datethuadd" value="${data}"/></i>
  </div>
`
document.getElementById("datebcadd").innerHTML = html; 
}
function UNC(){
const token = localStorage.getItem("token");
...
fetch(`http://localhost:8080/unc/generateCode?id=${id}`,{
      method:"GET",
  headers:{
  'Content-Type': 'application/json',
  'Authorization': 'Bearer '+ token,
...
fetch(`http://localhost:8080/baoco/generateCode?id=${id}`,{
      method:"GET",
  headers:{
  'Content-Type': 'application/json',
  'Authorization': 'Bearer '+ token,
...
html=`<div style="text-align:right; font-size:15px" >
            <i><label for="" >Mã:</label>
              <input type="text" name="codeuncadd" value="${data}" required></i> 
          </div>`
document.getElementById("codeuncadd").innerHTML = html; 
}
function generateCode1(data){
html=`<div style="text-align:right; font-size:15px" >
            <i><label for="" >Mã:</label>
              <input type="text" name="codebcadd" value="${data}" required></i> 
          </div>`
document.getElementById("codebcadd").innerHTML = html; 
}
//1 thêm phiếu chi
...
cashfund.addEventListener("click", function (e) {
  ...
  var codeuncadd = document.querySelector('input[name="codeuncadd"]').value;
  var moneyadd = document.querySelector('input[name="moneyadd"]').value;
  var dateadd = document.querySelector('input[name="dateuncadd"]').value;
  ...
  var phonekhadd = document.querySelector(
    'input[name="phonekhadd"]'
  ).value;
  var addresskhadd = document.querySelector(
    'input[name = "addresskhadd"]'
  ).value;
  if (dateadd === "") {
    alert("Cần nhập ngày");
    return;
  }
  fetch(`http://localhost:8080/unc/create?cccd=${cccdkhadd}`, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
      Authorization: "Bearer " + token,
...
function handleSearchClick1(e) {
  ...
  fetch(
    `http://localhost:8080/supplier/getByCCCDORTax?id=${id}&cccd=${cccdkhadd}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
...
cashfund1.addEventListener("click", function (e) {
  const token = localStorage.getItem("token");
  e.preventDefault();
  var notethuadd = document.querySelector(
    'input[name="notethuadd"]'
  ).value;
  var codebcadd = document.querySelector(
    'input[name="codebcadd"]'
  ).value;
  var moneythuadd = document.querySelector(
    'input[name="moneythuadd"]'
  ).value;
  var datethuadd = document.querySelector(
    'input[name="datethuadd"]'
  ).value;
  var cccdkhthuadd = document.querySelector(
    'input[name="cccdkhthuadd"]'
  ).value;
  var namekhthuadd = document.querySelector(
    'input[name="namekhthuadd"]'
  ).value;
  var phonekhthuadd = document.querySelector(
    'input[name="phonekhthuadd"]'
  ).value;
  var addresskhthuadd = document.querySelector(
    'input[name = "addresskhthuadd"]'
  ).value;
  ...
  fetch(`http://localhost:8080/baoco/create?cccd=${cccdkhthuadd}`, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
      Authorization: "Bearer " + token,
...
function handleSearchClick(e) {
  ...
  fetch(
    `http://localhost:8080/supplier/getByCCCDORTax?id=${id}&cccd=${cccdkhthuadd}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
...
search.addEventListener("submit", function (e) {
  ...
  fetch(`http://localhost:8080/banks/getbycode?code=${cccd}&id=${id}`, {
    method: "GET",
    headers: {
      "Content-Type": "application/json",
      Authorization: "Bearer " + token,
...
function getlist() {
  ...
  fetch(`http://localhost:8080/banks/getall?id=${id}`, {
    method: "GET",
    headers: {
      "Content-Type": "application/json",
      Authorization: "Bearer " + token,
...
console.log(data);
  const html = `
  <div id="dateandcodeuncfix">
    <div style="text-align: center; font-size: 15px" id="dateuncfix">
      <i><label for="">Ngày chi:</label> 
        <input type="date" name="dateuncfix" value="${data.paymentDate}"/></i>
    </div>
    <div style="text-align:right; font-size:15px" id="codeuncfix">
      <i><label for="" >Mã:</label>
        <input type="text" name="codeuncfix"value="${data.code}" disabled required></i> 
    </div>
  </div>
`;
document.getElementById("dateandcodeuncfix").innerHTML = html;
}
function rendercodeandatebc(data){
  const html = `
  <div id="dateandcodeuncfix">
    <div style="text-align: center; font-size: 15px" id="datebcfix">
      <i><label for="">Ngày chi:</label> 
        <input type="date" name="datebcfix" value="${data.collectionDate}"/></i>
    </div>
    <div style="text-align:right; font-size:15px" id="codebcfix">
      <i><label for="" >Mã:</label>
        <input type="text" name="codebcfix"value="${data.code}" disabled required></i> 
    </div>
  </div>
`;
document.getElementById("dateandcodebcfix").innerHTML = html;
}
...
function deleteCourse() {
  ...
  if (check === "a") {
    fetch(`http://localhost:8080/baoco/delete?id=${cccd}&userid=${id}`, {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
        Authorization: "Bearer " + token,
    ...
    fetch(`http://localhost:8080/unc/delete?id=${cccd}&userid=${id}`, {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
        Authorization: "Bearer " + token,
...
function getupdate1(id1) {
  ...
  fetch(`http://localhost:8080/banks/getbyid?id=${id1}`, {
    method: "GET",
    headers: {
      "Content-Type": "application/json",
      Authorization: "Bearer " + token,
...
function handleSearchClickFix(e) {
  ...
  fetch(
    `http://localhost:8080/supplier/getByCCCDORTax?id=${id}&cccd=${cccdkhfix}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
...
function savefix() {
  ...
  var addresskhfix = document.querySelector(
    'input[name="addresskhfix"]'
  ).value;
  var phonekhfix = document.querySelector(
    'input[name="phonekhfix"]'
  ).value;
...
function updateCourse() {
  ...
  console.log(check);
  if (check === "b") {
    fetch(`http://localhost:8080/unc/update?cccd=${cccdkhfix}`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        Authorization: "Bearer " + token,
    ...
    fetch(`http://localhost:8080/baoco/update?cccd=${cccdkhfix}`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        Authorization: "Bearer " + token,
...
function handleSearchClickthuFix(e) {
  const token = localStorage.getItem("token");
  e.preventDefault();
  var cccdkhthufix = document.querySelector(
    'input[name="cccdkhthufix"]'
  ).value;
  if (cccdkhthufix === "") {
    alert("Vui lòng nhập CCCD/Tax");
    return;
  ...
  fetch(
    `http://localhost:8080/supplier/getByCCCDORTax?id=${id}&cccd=${cccdkhthufix}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
...
function savethufix() {
  ...
  var cccdkhfix = document.querySelector(
    'input[name="cccdkhthufix"]'
  ).value;
  var namekhfix = document.querySelector(
    'input[name="namekhthufix"]'
  ).value;
  var addresskhfix = document.querySelector(
    'input[name="addresskhthufix"]'
  ).value;
  var phonekhfix = document.querySelector(
    'input[name="phonekhthufix"]'
  ).value;
  var notefix = document.querySelector('input[name="notethufix"]').value;
  var moneyfix = document.querySelector(
    'input[name="moneythufix"]'
  ).value;
  localStorage.setItem("datefix", datefix);
  localStorage.setItem("cccdkhfix", cccdkhfix);
  localStorage.setItem("namekhfix", namekhfix);
